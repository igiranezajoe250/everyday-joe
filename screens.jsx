      ...
      <div style={{ background: paper, borderRadius: 20, boxShadow: cardShadow, padding: '14px 14px' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: 12 }}>
          <div>
            ...
            <div style={{ fontSize: 26, fontWeight: 850, letterSpacing: '-0.02em', color: ink }}>
              {balance}
            </div>
            <button onClick={onGrowth} style={{
        ...
        <div className="pk-page-pad pk-soft-card" style={{ padding: '14px 20px 0' }}>
          <div style={{
            ...
            <div style={{ textAlign: 'center' }}>
              ...
              <div style={{
                fontSize: 30, fontWeight: 850, letterSpacing: '-0.02em',
                fontFeatureSettings: '"tnum"', color: ink,
              }}>
                {mask(fmtRWF(c.available))}
              </div>
              <div style={{ marginTop: 5, fontSize: 12, fontWeight: 650, color: ink55 }}>
  ...
  return (
    <div style={{ paddingBottom: 28 }}>
      ...
      <div style={{ padding: '28px 24px 8px' }}>
        ...
        <div style={{ fontSize: 40, fontWeight: 800, letterSpacing: '-0.025em', fontFeatureSettings: '"tnum"' }}>
  ...
  return (
    <div style={{ paddingBottom: 0, display: 'flex', flexDirection: 'column', minHeight: '100%' }}>
      ...
      <div style={{ padding: '4px 24px 20px' }}>
        ...
        <div style={{ display: 'flex', gap: 12, marginTop: 8, fontSize: 13, color: ink70 }}>
          <span>{v.sector}</span>
    ...
    <div style={{
      ...
      {keys.map((k) => (
        <button key={k} onClick={() => onPress(k)} style={{
          ...
          background: paper,
          border: `1px solid ${ink12}`,
          fontFamily: CC_MONO, fontSize: 18, color: ink,
