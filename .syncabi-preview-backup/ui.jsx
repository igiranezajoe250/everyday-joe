...
const CC_PALETTES = {
  teal:    { accent: '#2FAE9B', label: 'Teal'  },
  amber:   { accent: '#E2941F', label: 'Amber' },
  ink:     { accent: '#23241F', label: 'Ink'   },
  blue:    { accent: '#2A6FDB', label: 'Blue'  },
};

const CC_TYPES = {
  manrope:  '"Manrope", "Helvetica Neue", Helvetica, Arial, sans-serif',
  jakarta:  '"Plus Jakarta Sans", "Helvetica Neue", Helvetica, sans-serif',
  figtree:  '"Figtree", "Helvetica Neue", Helvetica, sans-serif',
};
...
const ink        = '#23241F';
const ink70      = 'rgba(35,36,31,0.66)';
const ink55      = 'rgba(35,36,31,0.50)';
const ink40      = 'rgba(35,36,31,0.38)';
const ink25      = 'rgba(35,36,31,0.22)';
const ink12      = 'rgba(35,36,31,0.11)';
const ink06      = 'rgba(35,36,31,0.055)';
const paper      = '#FFFFFF';
const paperSoft  = '#F5F4F0';
const canvas     = '#F7F6F2';   // soft warm app background
const teal       = '#2FAE9B';   // highlight / positive accent
const amber      = '#E2941F';   // chart / savings-growth gradient
const cardShadow = '0 10px 30px rgba(35,36,31,0.07)';
